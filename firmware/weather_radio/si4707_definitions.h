...
const unsigned long POWER_UP_TIME_MS = 1000;
...
#define RSQINT_MASK     0x0008
#define SAMEINT_MASK    0x0004
#define ASQINT_MASK     0x0002
#define STCINT_MASK     0x0001

#define MASK_BYTE(val, mask) ((val & (uint8_t)mask) == (uint8_t)mask)
#define MASK_INT(val, mask) ((val & mask) == mask)
